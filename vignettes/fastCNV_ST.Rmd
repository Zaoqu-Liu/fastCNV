...
STColon1 <- fastCNV(STColon1,
  sampleName = "STColon1", referenceVar = "annot",
...
referencelabels <- c(
  "epithelium&submucosa", "submucosa", "non neo epithelium",
  "squamous epithelium", "epithelium&lam propria", "lamina propria"
)

seuratList <- fastCNV(seuratList, sampleNames,
  referenceVar = "annot",
...
library(ggplot2)
ggplot(
  FetchData(STColon1, vars = c("annot", "cnv_fraction")),
